...
public class DemonSudoku extends ActionBarActivity {
    ...
    private void gameWin() {
        ...
        dialog.setMessage("游戏胜利！");
        dialog.setCancelable(true);
        dialog.setPositiveButton("继续下一场游戏", new DialogInterface.OnClickListener() {
            @Override
    ...
    private void saveGame(){
        ...
        if (saveGameInfo.insert(saveInfo)) {
            Toast.makeText(this, "储存进度成功！", Toast.LENGTH_SHORT).show();
            return;
        }
        Toast.makeText(this,"储存进度失败!",Toast.LENGTH_SHORT).show();
    }
