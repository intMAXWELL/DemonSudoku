    ...
    private void refresh(){
        ...
        if (saveGameInfoList != null) {
            ...
            for (int i = 0; i < saveGameInfoList.size(); i++) {
                ...
                map.put("used_time", "游戏时间:" + transferLongToDate
        ...
        else Toast.makeText(this, "当前没有储存的游戏进度哦", Toast.LENGTH_LONG).show();
    }
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {
                ...
                dialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        else Toast.makeText(LoadGame.this, "删除失败", Toast.LENGTH_SHORT).show();
